...
(function() {
    ...
    function resize(e) {
       ...
       grad.addColorStop(0, 'rgba(0, 105, 148, 0)');  // A deep ocean blue, fully transparent at the start
grad.addColorStop(0.3, 'rgba(0, 160, 176, 0.35)');  // A mid-tone turquoise with some opacity
grad.addColorStop(0.6, 'rgba(153, 204, 255, 0.35)');  // Lighter shade of blue towards the top
grad.addColorStop(1, 'rgba(102, 205, 170, 0.35)');
